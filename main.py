...
░░░╚═╝░░░╚═╝░░╚═╝░░╚═╝╚═╝░░░╚═╝░░░╚══════╝╚═════╝░╚═╝░░╚═╝╚═╝╚═════╝░░╚═════╝░╚══════╝
    ...
    print_border("WHITEBRIDGE NETWORK", Fore.GREEN)
...
def get_available_scripts(language):
    scripts = {
        'vi': [
            {"name": "1. Tự động hoàn thành nhiệm vụ │ Whitebridge Network", "value": "autotask"},

            {"name": "2. Thoát", "value": "exit"},
        ],
        'en': [
            {"name": "1. Auto Social Tasks │ Whitebridge Network", "value": "autotask"},
